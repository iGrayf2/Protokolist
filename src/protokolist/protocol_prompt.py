...
Андрей Аркадьевич — руководитель, босс, ведущий совещаний
Вячеслав — директор
Александра — менеджер, руководитель
...
Мария — мастер смены
Юлия — мастер смены
Людмила — мастер смены
Светлана — мастер смены
Алексей — начальник
Дмитрий — снабженец
Иван — технолог
"""

SHIFT_SUPERVISOR_RULE = """Мастера смен работают посменно. Всего мастеров смен шесть: Алла, Ольга, Мария, Юлия, Людмила, Светлана. На одном совещании обычно присутствуют только три мастера из шести. Не считай автоматически, что присутствовали все шесть; определяй присутствующих только по репликам и контексту."""
...
Важное правило по мастерам смен:
{SHIFT_SUPERVISOR_RULE}

Правила обработки:
1. Диаризация: если по контексту можно понять говорящего, используй имена из списка. Если нельзя — пиши «Участник N».
2. Если имя совпадает у нескольких людей, например Андрей или Наталья, уточняй роль только при наличии контекста.
3. Стенограмма: сделай тезисную стенограмму в формате [Время] Имя: краткое содержание реплики.
4. Итоги: сформируй основные темы, принятые решения и список задач.
5. Если ответственный не назван явно, но задача очевидна — пиши «Не определен».
6. Если срок не был озвучен — пиши «не определен».
7. Тон: деловой, сухой, без оценочных суждений.
